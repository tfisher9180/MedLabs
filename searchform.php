  ...
  <div class="form-container">
    <div class="form-control">
    	<label for="<?php echo $unique_id; ?>">
  	   ...
  	   <input type="search" id="<?php echo $unique_id; ?>" class="search-field" placeholder="<?php echo esc_attr_x( 'Enter search term(s)', 'placeholder', 'medlabs' ); ?>" value="<?php echo get_search_query(); ?>" name="s" />
    </div>
    <div class="form-control">
